# AI Systems & Cloud Architecture Portfolio
...
- Observability, reliability, and operational considerations
        ...
        ### LLM-Powered Resume Builder Platform
        An end-to-end AI-enabled platform combining LLM services, backend APIs, and persistent data storage.  
        Focus areas: LLM orchestration, API design, data modeling, and system architecture.
        
        [View Project Architecture & Design →](/projects/resume-llm)
        
        ### Cloud & Data Platform Architecture
        A cloud-native platform design focused on data ingestion, storage, and analysis to support AI-enabled applications.  
        Focus areas: AWS architecture, data pipelines, and platform-level design.
        
        [View Platform Design →](/projects/cloud-data)
